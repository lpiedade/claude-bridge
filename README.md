...
| `/usage month` | 🟢 Local | Stacked bar chart of monthly spend across all sessions for the last 6 calendar months, annotated with the MoM delta in % over each bar and a caption summarising current vs previous month. |
